...
% 
% The function looks at the vector c and takes the
% coefficients (from the objective function) corresponding to the basic variables (indicies
% and puts them in a vector c_b and then takes the coefficients (from the objective function) 
% corresponding to the nonbasic variables (indicies and puts them in a vector c_N. 
% 
...
%
% [final_sol, histx, histy] = SIMPLEX_SOLVE(c,A,b,n,m) The function requires an input of a vector c, 
% matrix A, a vector b, number of variables (n), and number of constraints 
% (m). 
%
% This function follows and actually solves the input program
% using the simplex algorithm. 

% Returns the final optimal solution (vector) and
% value.
